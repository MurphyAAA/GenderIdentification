...
if __name__ == '__main__':
    ...
    # ll_res_init_gmm = np.load("data/GMM_4D_3G_init_ll.npy")
    # gmm_res = json.load(open("data/GMM_4D_3G_EM.json"))
    # GMM_gen_res = json.load(open("data/GMM_4D_4G_EM_LBG.json"))


    # mygmm = GMM_iteration(D, gmm, False, False, 0.01)
